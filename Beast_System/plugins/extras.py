...
from Beast_System.plugins.Mongo_DB.tree import add_inspector, add_enforcers, get_data
from Beast_System import ENFORCERS, INSPECTORS, SIBYL, session
from Beast_System import System, system_cmd
from Beast_System import Sibyl_logs
...
try:
    from Beast_System import HEROKU_API_KEY, HEROKU_APP_NAME
...
json_file = os.path.join(os.getcwd(), "Beast_System\\elevated_users.json")
