...
from Beast_System.strings import on_string
import logging
import importlib
import asyncio
import time
...
from Beast_System.plugins import to_load
...
for load in to_load:
    try:
        imported = importlib.import_module("Beast_System.plugins." + load)
